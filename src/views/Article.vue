    ...
    <div class="container page">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-8 offset-md-2">
          <RwvCommentEditor v-if="isAuthenticated" :slug="slug" :userImage="currentUser.image"></RwvCommentEditor>
          <p v-else>
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    Promise.all([
      store.dispatch(ARTICLE_TYPE.FETCH_ARTICLE, to.params.slug),
      store.dispatch(ARTICLE_TYPE.FETCH_COMMENTS, to.params.slug)
    ]).then(() => {
      next();
    });
  },
